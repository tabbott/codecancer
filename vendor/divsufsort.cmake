...
ExternalProject_Add(
    libdivsufsort-2.0.1
    URL ${CMAKE_CURRENT_SOURCE_DIR}/vendor/libdivsufsort-2.0.1.tar.bz2
    CMAKE_ARGS
...
set(LIBDIVSUFSORT_LIBRARY
    ${LIBDIVSUFSORT_ROOT}/lib/${CMAKE_FIND_LIBRARY_PREFIXES}divsufsort${CMAKE_STATIC_LIBRARY_SUFFIX}
)

set(LIBDIVSUFSORT_LIBRARY64
    ${LIBDIVSUFSORT_ROOT}/lib/${CMAKE_FIND_LIBRARY_PREFIXES}divsufsort64${CMAKE_STATIC_LIBRARY_SUFFIX}
)
